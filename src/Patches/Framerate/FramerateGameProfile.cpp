...
// Static backing arrays outlive the borrowed profile spans.
constexpr std::array<FramerateWriteContract, 17> kWrites471{
        ...
        FramerateWriteContract{{FeatureId::framerate, "render first countdown duration",
            VersionedOperationKind::byte_patch, 0x00249A5E, 5, PatternOf<0xB8, 0x78, 0x00, 0x00, 0x00>(), {}, 10},
            FramerateWriteValue::two_seconds, runtime_image::MemoryKind::code},
        FramerateWriteContract{{FeatureId::framerate, "render second countdown duration",
...
constexpr std::array<FramerateHookContract, 53> kHooks471{        FramerateHookContract{FramerateHookId::MovieClipGoto,
        ...
        FramerateHookContract{FramerateHookId::GreatGoodLifetimeOperand,
            {FeatureId::framerate, "GreatGoodLifetimeOperand", VersionedOperationKind::mid_hook,
             0x002464A8, 5, PatternOf<0xD8, 0x48, 0x18, 0xDE, 0xC1>(), {}, 38}, FramerateRegister::eax},
        FramerateHookContract{FramerateHookId::GreatGoodFrameOperand,
            {FeatureId::framerate, "GreatGoodFrameOperand", VersionedOperationKind::mid_hook,
             0x00246528, 8, PatternOf<0xD8, 0x71, 0x18, 0xE8, 0xF0, 0x3A, 0xEC, 0xFF>(), {}, 39}, FramerateRegister::ecx},
        FramerateHookContract{FramerateHookId::EffectLifetimeAOperand,
            {FeatureId::framerate, "EffectLifetimeAOperand", VersionedOperationKind::mid_hook,
             0x00248F00, 5, PatternOf<0xD8, 0x49, 0x18, 0xDE, 0xC1>(), {}, 40}, FramerateRegister::ecx},
        FramerateHookContract{FramerateHookId::EffectFrameAOperand,
            {FeatureId::framerate, "EffectFrameAOperand", VersionedOperationKind::mid_hook,
             0x00248F8C, 8, PatternOf<0xD8, 0x72, 0x18, 0xE8, 0x8C, 0x10, 0xEC, 0xFF>(), {}, 41}, FramerateRegister::edx},
        FramerateHookContract{FramerateHookId::EffectLifetimeBOperand,
            {FeatureId::framerate, "EffectLifetimeBOperand", VersionedOperationKind::mid_hook,
             0x0024912B, 5, PatternOf<0xD8, 0x49, 0x18, 0xDE, 0xC1>(), {}, 42}, FramerateRegister::ecx},
        FramerateHookContract{FramerateHookId::EffectFrameBOperand,
            {FeatureId::framerate, "EffectFrameBOperand", VersionedOperationKind::mid_hook,
             0x002491E0, 6, PatternOf<0xD8, 0x72, 0x18, 0xD9, 0x5D, 0xA0>(), {}, 43}, FramerateRegister::edx},
        FramerateHookContract{FramerateHookId::DirectEffectFrameOperand,
            {FeatureId::framerate, "DirectEffectFrameOperand", VersionedOperationKind::mid_hook,
             0x00249C14, 8, PatternOf<0xD8, 0x72, 0x18, 0xE8, 0x04, 0x04, 0xEC, 0xFF>(), {}, 44}, FramerateRegister::edx},
        FramerateHookContract{FramerateHookId::ChartEffectFrameAOperand,
            {FeatureId::framerate, "ChartEffectFrameAOperand", VersionedOperationKind::mid_hook,
             0x0024BC8B, 8, PatternOf<0xD8, 0x71, 0x18, 0xE8, 0x8D, 0xE3, 0xEB, 0xFF>(), {}, 45}, FramerateRegister::ecx},
        FramerateHookContract{FramerateHookId::ChartEffectFrameBOperand,
            {FeatureId::framerate, "ChartEffectFrameBOperand", VersionedOperationKind::mid_hook,
             0x0024CC8A, 8, PatternOf<0xD8, 0x71, 0x18, 0xE8, 0x8E, 0xD3, 0xEB, 0xFF>(), {}, 46}, FramerateRegister::ecx},
        FramerateHookContract{FramerateHookId::ChartEffectFrameCOperand,
            {FeatureId::framerate, "ChartEffectFrameCOperand", VersionedOperationKind::mid_hook,
             0x0024CCBE, 8, PatternOf<0xD8, 0x72, 0x18, 0xE8, 0x5A, 0xD3, 0xEB, 0xFF>(), {}, 47}, FramerateRegister::edx},
        FramerateHookContract{FramerateHookId::ChartEffectFrameDOperand,
            {FeatureId::framerate, "ChartEffectFrameDOperand", VersionedOperationKind::mid_hook,
             0x0024D836, 8, PatternOf<0xD8, 0x70, 0x18, 0xE8, 0xE2, 0xC7, 0xEB, 0xFF>(), {}, 48}, FramerateRegister::eax},
        FramerateHookContract{FramerateHookId::FixedVisualFrameOperand,
            {FeatureId::framerate, "FixedVisualFrameOperand", VersionedOperationKind::mid_hook,
             0x00250AD5, 8, PatternOf<0xD8, 0x71, 0x18, 0xE8, 0x43, 0x95, 0xEB, 0xFF>(), {}, 49}, FramerateRegister::ecx},
...
constexpr std::array<FramerateTargetContract, 10> kTargets471{        FramerateTargetContract{FramerateNativeTarget::audio_resync_continuation,
            {FeatureId::framerate, "audio_resync_continuation", VersionedOperationKind::read_only_contract,
...
FramerateGameProfile MakeProfile(GameImageVariant variant) noexcept {
    return {GameBuild::groove_coaster_471, variant, kWrites471, kHooks471, kTargets471, {
        ...
        .tune_countdown_owner = FramerateRegister::edx,
        .countdown_asset_source = FramerateRegister::ecx,
        .tutorial_elapsed_source = FramerateRegister::edx,
        .unlock_reward_prompt_available = true,
    }, SummarizeNativeEffectTiming()};
}

// The 2.06 diagnostic inventory describes its 32 mapped timing hooks.
// The separate 4.71 registration/duration inventory above is not attributed to this build.
// Static backing arrays outlive the borrowed profile spans.
constexpr std::array<FramerateWriteContract, 17> kWrites206{
        FramerateWriteContract{{FeatureId::framerate, "gameplay frame milliseconds",
            VersionedOperationKind::byte_patch, 0x2B9AAC, 4, PatternOf<0x55, 0x55, 0x85, 0x41>(), {}, 0},
            FramerateWriteValue::frame_ms, runtime_image::MemoryKind::data},
        FramerateWriteContract{{FeatureId::framerate, "visual frame milliseconds",
            VersionedOperationKind::byte_patch, 0x2B3F1C, 4, PatternOf<0x55, 0x55, 0x85, 0x41>(), {}, 1},
            FramerateWriteValue::frame_ms, runtime_image::MemoryKind::data},
        FramerateWriteContract{{FeatureId::framerate, "gameplay frame seconds",
            VersionedOperationKind::byte_patch, 0x2B9C5C, 4, PatternOf<0x89, 0x88, 0x88, 0x3C>(), {}, 2},
            FramerateWriteValue::frame_seconds, runtime_image::MemoryKind::data},
        FramerateWriteContract{{FeatureId::framerate, "render smoothing step",
            VersionedOperationKind::byte_patch, 0x2A9AE8, 4, PatternOf<0x00, 0x00, 0x80, 0x40>(), {}, 3},
            FramerateWriteValue::smoothing, runtime_image::MemoryKind::data},
        FramerateWriteContract{{FeatureId::framerate, "render offset-decay step",
            VersionedOperationKind::byte_patch, 0x2A9AEC, 4, PatternOf<0x00, 0x00, 0xA0, 0x40>(), {}, 4},
            FramerateWriteValue::decay, runtime_image::MemoryKind::data},
        FramerateWriteContract{{FeatureId::framerate, "XIO repeat initial duration",
            VersionedOperationKind::byte_patch, 0x46F6C, 6, PatternOf<0xC7, 0x00, 0x10, 0x00, 0x00, 0x00>(), {}, 5},
            FramerateWriteValue::repeat_initial, runtime_image::MemoryKind::code},
        FramerateWriteContract{{FeatureId::framerate, "XIO repeat next duration",
            VersionedOperationKind::byte_patch, 0x46F7D, 6, PatternOf<0xC7, 0x00, 0x08, 0x00, 0x00, 0x00>(), {}, 6},
            FramerateWriteValue::repeat_next, runtime_image::MemoryKind::code},
        FramerateWriteContract{{FeatureId::framerate, "native keyboard repeat initial duration",
            VersionedOperationKind::byte_patch, 0x50D03, 10, PatternOf<0xC7, 0x86, 0xD4, 0x02, 0x00, 0x00, 0x10, 0x00, 0x00, 0x00>(), {}, 7},
            FramerateWriteValue::repeat_initial, runtime_image::MemoryKind::code},
        FramerateWriteContract{{FeatureId::framerate, "native keyboard repeat next duration",
            VersionedOperationKind::byte_patch, 0x50D0D, 10, PatternOf<0xC7, 0x86, 0xD8, 0x02, 0x00, 0x00, 0x08, 0x00, 0x00, 0x00>(), {}, 8},
            FramerateWriteValue::repeat_next, runtime_image::MemoryKind::code},
        FramerateWriteContract{{FeatureId::framerate, "gameplay countdown duration",
            VersionedOperationKind::byte_patch, 0x1C4930, 10, PatternOf<0xC7, 0x82, 0x14, 0x1D, 0x00, 0x00, 0x78, 0x00, 0x00, 0x00>(), {}, 9},
            FramerateWriteValue::two_seconds, runtime_image::MemoryKind::code},
        FramerateWriteContract{{FeatureId::framerate, "render first countdown duration",
            VersionedOperationKind::byte_patch, 0x2161BC, 5, PatternOf<0xB9, 0x78, 0x00, 0x00, 0x00>(), {}, 10},
            FramerateWriteValue::two_seconds, runtime_image::MemoryKind::code},
        FramerateWriteContract{{FeatureId::framerate, "render second countdown duration",
            VersionedOperationKind::byte_patch, 0x2161D1, 5, PatternOf<0xB8, 0x78, 0x00, 0x00, 0x00>(), {}, 11},
            FramerateWriteValue::two_seconds, runtime_image::MemoryKind::code},
        FramerateWriteContract{{FeatureId::framerate, "palette normalizer operand one",
            VersionedOperationKind::byte_patch, 0x1FB50F, 6, PatternOf<0xD8, 0x2D, 0xE0, 0x95, 0x6B, 0x00>(), {}, 12},
            FramerateWriteValue::target_operand, runtime_image::MemoryKind::code},
        FramerateWriteContract{{FeatureId::framerate, "palette normalizer operand two",
            VersionedOperationKind::byte_patch, 0x1FB515, 6, PatternOf<0xD8, 0x35, 0xE0, 0x95, 0x6B, 0x00>(), {}, 13},
            FramerateWriteValue::target_operand, runtime_image::MemoryKind::code},
        FramerateWriteContract{{FeatureId::framerate, "chart seconds-to-frames operand",
            VersionedOperationKind::byte_patch, 0x1C32C6, 6, PatternOf<0xD8, 0x0D, 0xE0, 0x95, 0x6B, 0x00>(), {}, 14},
            FramerateWriteValue::target_operand, runtime_image::MemoryKind::code},
        FramerateWriteContract{{FeatureId::framerate, "non-song menu repeat initial duration",
            VersionedOperationKind::byte_patch, 0x33D1DC, 4, PatternOf<0x10, 0x00, 0x00, 0x00>(), {}, 15},
            FramerateWriteValue::menu_initial, runtime_image::MemoryKind::data},
        FramerateWriteContract{{FeatureId::framerate, "non-song menu repeat interval",
            VersionedOperationKind::byte_patch, 0x33D1E0, 4, PatternOf<0x03, 0x00, 0x00, 0x00>(), {}, 16},
            FramerateWriteValue::menu_interval, runtime_image::MemoryKind::data}
};
constexpr std::array<FramerateHookContract, 48> kHooks206{        FramerateHookContract{FramerateHookId::MovieClipGoto,
            {FeatureId::framerate, "MovieClipGoto", VersionedOperationKind::inline_hook, 0xD3F30, 7, PatternOf<0x6A, 0xFF, 0x68, 0x39, 0xA9, 0x63, 0x00>(), {}, 17}, {}},
        FramerateHookContract{FramerateHookId::MovieClipAdvance,
            {FeatureId::framerate, "MovieClipAdvance", VersionedOperationKind::inline_hook, 0xD4DC0, 5, PatternOf<0x56, 0x8B, 0xF1, 0x8B, 0x06, 0x8B, 0x90, 0x4C, 0x01, 0x00, 0x00>(), {}, 18}, {}},
        FramerateHookContract{FramerateHookId::PaletteCompare,
            {FeatureId::framerate, "PaletteCompare", VersionedOperationKind::mid_hook, 0x1FB4A0, 6, PatternOf<0x83, 0x78, 0x0C, 0x3C, 0x7D, 0x0F>(), {}, 19}, {}},
        FramerateHookContract{FramerateHookId::StageClipFrame,
            {FeatureId::framerate, "StageClipFrame", VersionedOperationKind::mid_hook, 0x211154, 9, PatternOf<0x89, 0x4D, 0xF8, 0x8B, 0x95, 0x80, 0xFE, 0xFF, 0xFF>(), {}, 20}, {}},
        FramerateHookContract{FramerateHookId::IfblWait,
            {FeatureId::framerate, "IfblWait", VersionedOperationKind::mid_hook, 0x1FFC54, 6, PatternOf<0x89, 0x4A, 0x3C, 0x8B, 0x55, 0xF8>(), {}, 21}, {}},
        FramerateHookContract{FramerateHookId::StageBgmPreload,
            {FeatureId::framerate, "StageBgmPreload", VersionedOperationKind::mid_hook, 0x1E3E37, 6, PatternOf<0x83, 0xC1, 0x01, 0x8B, 0x55, 0xF0>(), {}, 22}, {}},
        FramerateHookContract{FramerateHookId::TuneCountdownCompare,
            {FeatureId::framerate, "TuneCountdownCompare", VersionedOperationKind::mid_hook, 0x1C4C87, 7, PatternOf<0x83, 0xB8, 0x14, 0x1D, 0x00, 0x00, 0x78>(), {}, 23}, {}},
        FramerateHookContract{FramerateHookId::AudioSkipMargin,
            {FeatureId::framerate, "AudioSkipMargin", VersionedOperationKind::mid_hook, 0x20CCC2, 6, PatternOf<0x8B, 0x45, 0xF4, 0x99, 0x33, 0xC2>(), {}, 24}, {}},
        FramerateHookContract{FramerateHookId::AudioSkipInterval,
            {FeatureId::framerate, "AudioSkipInterval", VersionedOperationKind::mid_hook, 0x20CCF0, 5, PatternOf<0xF7, 0x79, 0x3C, 0x85, 0xD2>(), {}, 25}, {}},
        FramerateHookContract{FramerateHookId::AudioResyncPolicy,
            {FeatureId::framerate, "AudioResyncPolicy", VersionedOperationKind::mid_hook, 0x20CCF7, 9, PatternOf<0x8B, 0x55, 0xF8, 0x52, 0xE8, 0xD0, 0x74, 0xFD, 0xFF, 0x8B, 0xC8, 0xE8, 0xE9, 0x80, 0xFD, 0xFF, 0xC7, 0x45, 0xF4, 0x00, 0x00>(), {}, 26}, {}},
        FramerateHookContract{FramerateHookId::GameplaySongClock,
            {FeatureId::framerate, "GameplaySongClock", VersionedOperationKind::mid_hook, 0x1C511A, 5, PatternOf<0xE8, 0x81, 0x7A, 0x04, 0x00>(), {}, 27}, {}},
        FramerateHookContract{FramerateHookId::GameplayEffectAdvance,
            {FeatureId::framerate, "GameplayEffectAdvance", VersionedOperationKind::mid_hook, 0x1C5195, 5, PatternOf<0xE8, 0x56, 0x82, 0x00, 0x00>(), {}, 28}, {}},
        FramerateHookContract{FramerateHookId::EffectCadence6,
            {FeatureId::framerate, "EffectCadence6", VersionedOperationKind::mid_hook, 0x20D740, 8, PatternOf<0x85, 0xD2, 0x0F, 0x85, 0x36, 0x02, 0x00, 0x00>(), {}, 29}, {}},
        FramerateHookContract{FramerateHookId::EffectCadence5,
            {FeatureId::framerate, "EffectCadence5", VersionedOperationKind::mid_hook, 0x20D9DC, 8, PatternOf<0x85, 0xD2, 0x0F, 0x85, 0x29, 0x03, 0x00, 0x00>(), {}, 30}, {}},
        FramerateHookContract{FramerateHookId::EffectCadence4,
            {FeatureId::framerate, "EffectCadence4", VersionedOperationKind::mid_hook, 0x20DDA1, 8, PatternOf<0x85, 0xD2, 0x0F, 0x85, 0xB3, 0x01, 0x00, 0x00>(), {}, 31}, {}},
        FramerateHookContract{FramerateHookId::EffectCadence16A,
            {FeatureId::framerate, "EffectCadence16A", VersionedOperationKind::mid_hook, 0x20E318, 11, PatternOf<0x85, 0xD2, 0x74, 0x59, 0x83, 0xBD, 0xF8, 0xFD, 0xFF, 0xFF, 0x01>(), {}, 32}, {}},
        FramerateHookContract{FramerateHookId::EffectCadence16B,
            {FeatureId::framerate, "EffectCadence16B", VersionedOperationKind::mid_hook, 0x20E334, 6, PatternOf<0x81, 0xE1, 0x0F, 0x00, 0x00, 0x80>(), {}, 33}, {}},
        FramerateHookContract{FramerateHookId::EffectCadence8,
            {FeatureId::framerate, "EffectCadence8", VersionedOperationKind::mid_hook, 0x20E36D, 8, PatternOf<0x85, 0xC0, 0x0F, 0x85, 0xF7, 0x04, 0x00, 0x00>(), {}, 34}, {}},
        FramerateHookContract{FramerateHookId::GameplayBlink,
            {FeatureId::framerate, "GameplayBlink", VersionedOperationKind::mid_hook, 0x21699E, 7, PatternOf<0xD1, 0xF8, 0x25, 0x01, 0x00, 0x00, 0x80>(), {}, 37}, {}},
        FramerateHookContract{FramerateHookId::GreatGoodLifetimeOperand,
            {FeatureId::framerate, "GreatGoodLifetimeOperand", VersionedOperationKind::mid_hook, 0x2130A8, 5, PatternOf<0xD8, 0x48, 0x18, 0xDE, 0xC1>(), {}, 38}, FramerateRegister::eax},
        FramerateHookContract{FramerateHookId::GreatGoodFrameOperand,
            {FeatureId::framerate, "GreatGoodFrameOperand", VersionedOperationKind::mid_hook, 0x213128, 8, PatternOf<0xD8, 0x71, 0x18, 0xE8, 0x30, 0xC3, 0xEE, 0xFF>(), {}, 39}, FramerateRegister::ecx},
        FramerateHookContract{FramerateHookId::EffectLifetimeAOperand,
            {FeatureId::framerate, "EffectLifetimeAOperand", VersionedOperationKind::mid_hook, 0x2156D5, 5, PatternOf<0xD8, 0x48, 0x18, 0xDE, 0xC1>(), {}, 40}, FramerateRegister::eax},
        FramerateHookContract{FramerateHookId::EffectFrameAOperand,
            {FeatureId::framerate, "EffectFrameAOperand", VersionedOperationKind::mid_hook, 0x215761, 8, PatternOf<0xD8, 0x71, 0x18, 0xE8, 0xF7, 0x9C, 0xEE, 0xFF>(), {}, 41}, FramerateRegister::ecx},
        FramerateHookContract{FramerateHookId::EffectLifetimeBOperand,
            {FeatureId::framerate, "EffectLifetimeBOperand", VersionedOperationKind::mid_hook, 0x215900, 5, PatternOf<0xD8, 0x4A, 0x18, 0xDE, 0xC1>(), {}, 42}, FramerateRegister::edx},
        FramerateHookContract{FramerateHookId::EffectFrameBOperand,
            {FeatureId::framerate, "EffectFrameBOperand", VersionedOperationKind::mid_hook, 0x2159B5, 6, PatternOf<0xD8, 0x70, 0x18, 0xD9, 0x5D, 0xA8>(), {}, 43}, FramerateRegister::eax},
        FramerateHookContract{FramerateHookId::DirectEffectFrameOperand,
            {FeatureId::framerate, "DirectEffectFrameOperand", VersionedOperationKind::mid_hook, 0x2163F9, 8, PatternOf<0xD8, 0x71, 0x18, 0xE8, 0x5F, 0x90, 0xEE, 0xFF>(), {}, 44}, FramerateRegister::ecx},
        FramerateHookContract{FramerateHookId::ChartEffectFrameAOperand,
            {FeatureId::framerate, "ChartEffectFrameAOperand", VersionedOperationKind::mid_hook, 0x218B3B, 8, PatternOf<0xD8, 0x71, 0x18, 0xE8, 0x1D, 0x69, 0xEE, 0xFF>(), {}, 45}, FramerateRegister::ecx},
        FramerateHookContract{FramerateHookId::ChartEffectFrameBOperand,
            {FeatureId::framerate, "ChartEffectFrameBOperand", VersionedOperationKind::mid_hook, 0x219B13, 8, PatternOf<0xD8, 0x71, 0x18, 0xE8, 0x45, 0x59, 0xEE, 0xFF>(), {}, 46}, FramerateRegister::ecx},
        FramerateHookContract{FramerateHookId::ChartEffectFrameCOperand,
            {FeatureId::framerate, "ChartEffectFrameCOperand", VersionedOperationKind::mid_hook, 0x219B47, 8, PatternOf<0xD8, 0x72, 0x18, 0xE8, 0x11, 0x59, 0xEE, 0xFF>(), {}, 47}, FramerateRegister::edx},
        FramerateHookContract{FramerateHookId::ChartEffectFrameDOperand,
            {FeatureId::framerate, "ChartEffectFrameDOperand", VersionedOperationKind::mid_hook, 0x21A698, 8, PatternOf<0xD8, 0x70, 0x18, 0xE8, 0xC0, 0x4D, 0xEE, 0xFF>(), {}, 48}, FramerateRegister::eax},
        FramerateHookContract{FramerateHookId::FixedVisualFrameOperand,
            {FeatureId::framerate, "FixedVisualFrameOperand", VersionedOperationKind::mid_hook, 0x21D885, 8, PatternOf<0xD8, 0x71, 0x18, 0xE8, 0xD3, 0x1B, 0xEE, 0xFF>(), {}, 49}, FramerateRegister::ecx},
        FramerateHookContract{FramerateHookId::GameplayCountdownAssetFrame,
            {FeatureId::framerate, "GameplayCountdownAssetFrame", VersionedOperationKind::mid_hook, 0x2161FA, 6, PatternOf<0x89, 0x51, 0x08, 0x51, 0xD9, 0xEE>(), {}, 50}, {}},
        FramerateHookContract{FramerateHookId::PlayerPositionInitA,
            {FeatureId::framerate, "PlayerPositionInitA", VersionedOperationKind::mid_hook, 0x1C3861, 7, PatternOf<0x89, 0x84, 0x91, 0x4C, 0x1D, 0x00, 0x00>(), {}, 51}, {}},
        FramerateHookContract{FramerateHookId::PlayerPositionInitB,
            {FeatureId::framerate, "PlayerPositionInitB", VersionedOperationKind::mid_hook, 0x1C38E5, 7, PatternOf<0x89, 0x84, 0x8A, 0x4C, 0x1D, 0x00, 0x00>(), {}, 52}, {}},
        FramerateHookContract{FramerateHookId::PlayerPositionInitC,
            {FeatureId::framerate, "PlayerPositionInitC", VersionedOperationKind::mid_hook, 0x1C3BB2, 7, PatternOf<0x89, 0x84, 0x8A, 0x4C, 0x1D, 0x00, 0x00>(), {}, 53}, {}},
        FramerateHookContract{FramerateHookId::PlayerPositionInitD,
            {FeatureId::framerate, "PlayerPositionInitD", VersionedOperationKind::mid_hook, 0x1C3C2C, 7, PatternOf<0x89, 0x84, 0x8A, 0x4C, 0x1D, 0x00, 0x00>(), {}, 54}, {}},
        FramerateHookContract{FramerateHookId::PlayerPositionAssetFrame,
            {FeatureId::framerate, "PlayerPositionAssetFrame", VersionedOperationKind::mid_hook, 0x21BD81, 7, PatternOf<0x2B, 0x84, 0x8A, 0x4C, 0x1D, 0x00, 0x00>(), {}, 55}, {}},
        FramerateHookContract{FramerateHookId::PlayerPositionDenominatorA,
            {FeatureId::framerate, "PlayerPositionDenominatorA", VersionedOperationKind::mid_hook, 0x21C56B, 6, PatternOf<0xDB, 0x80, 0xC4, 0x00, 0x00, 0x00>(), {}, 56}, {}},
        FramerateHookContract{FramerateHookId::PlayerPositionDenominatorB,
            {FeatureId::framerate, "PlayerPositionDenominatorB", VersionedOperationKind::mid_hook, 0x21CB30, 6, PatternOf<0xDB, 0x80, 0xC4, 0x00, 0x00, 0x00>(), {}, 57}, {}},
        FramerateHookContract{FramerateHookId::EffectFlowItemFrame,
            {FeatureId::framerate, "EffectFlowItemFrame", VersionedOperationKind::mid_hook, 0x1CCE60, 6, PatternOf<0x89, 0x42, 0x08, 0x8B, 0x45, 0xF8>(), {}, 58}, {}},
        FramerateHookContract{FramerateHookId::EffectTutorialElapsed,
            {FeatureId::framerate, "EffectTutorialElapsed", VersionedOperationKind::mid_hook, 0x215D2B, 6, PatternOf<0x89, 0x85, 0x7C, 0xFF, 0xFF, 0xFF>(), {}, 59}, {}},
        FramerateHookContract{FramerateHookId::EffectChartPreRollDuration,
            {FeatureId::framerate, "EffectChartPreRollDuration", VersionedOperationKind::mid_hook, 0x2177E4, 6, PatternOf<0x89, 0x45, 0x9C, 0x8B, 0x45, 0x98>(), {}, 60}, {}},
        FramerateHookContract{FramerateHookId::EffectPlayerModuloDividend,
            {FeatureId::framerate, "EffectPlayerModuloDividend", VersionedOperationKind::mid_hook, 0x21D4FE, 8, PatternOf<0xF7, 0xF9, 0x8B, 0x85, 0xDC, 0xFC, 0xFF, 0xFF>(), {}, 61}, {}},
        FramerateHookContract{FramerateHookId::MovieClipPreprocessVisit,
            {FeatureId::framerate, "MovieClipPreprocessVisit", VersionedOperationKind::inline_hook, 0xE4CA0, 7, PatternOf<0x6A, 0xFF, 0x68, 0x20, 0xB9, 0x63, 0x00>(), {}, 62}, {}},
        FramerateHookContract{FramerateHookId::RankingEntryCounterStore,
            {FeatureId::framerate, "RankingEntryCounterStore", VersionedOperationKind::mid_hook, 0x1EA97A, 5, PatternOf<0x8B, 0x4D, 0xE8, 0x89, 0x01>(), {}, 63}, {}},
        FramerateHookContract{FramerateHookId::HitChartEntryCounterStore,
            {FeatureId::framerate, "HitChartEntryCounterStore", VersionedOperationKind::mid_hook, 0x22BFFF, 6, PatternOf<0x8B, 0x8D, 0x6C, 0xFF, 0xFF, 0xFF>(), {}, 64}, {}},
        FramerateHookContract{FramerateHookId::NavigatorAdvance,
            {FeatureId::framerate, "NavigatorAdvance", VersionedOperationKind::inline_hook, 0x14C390, 5, PatternOf<0x55, 0x8B, 0xEC, 0x6A, 0xFF, 0x68, 0xC4, 0xD9, 0x63, 0x00, 0x64, 0xA1, 0x00, 0x00, 0x00>(), {}, 68}, {}},
        FramerateHookContract{FramerateHookId::OuterFrame,
            {FeatureId::framerate, "OuterFrame", VersionedOperationKind::mid_hook, 0x49F40, 5, PatternOf<0x56, 0x8B, 0xF1, 0x8B, 0x06, 0x8B, 0x50, 0x24>(), {}, 69}, {}}
};
constexpr std::array<FramerateTargetContract, 7> kTargets206{        FramerateTargetContract{FramerateNativeTarget::audio_resync_continuation,
            {FeatureId::framerate, "audio_resync_continuation", VersionedOperationKind::read_only_contract, 0x20CD07, 7, PatternOf<0xC7, 0x45, 0xF4, 0x00, 0x00, 0x00, 0x00>(), {}, 0,
             SiteDisposition::verify_only}},
        FramerateTargetContract{FramerateNativeTarget::get_sound_manager,
            {FeatureId::framerate, "get_sound_manager", VersionedOperationKind::read_only_contract, 0x1E41D0, 8, PatternOf<0x55, 0x8B, 0xEC, 0xA1, 0x10, 0xA9, 0x7A, 0x00>(), {}, 0,
             SiteDisposition::verify_only}},
        FramerateTargetContract{FramerateNativeTarget::get_group_cursor,
            {FeatureId::framerate, "get_group_cursor", VersionedOperationKind::read_only_contract, 0x1E5C60, 10, PatternOf<0x55, 0x8B, 0xEC, 0x6A, 0xFF, 0x68, 0x36, 0x01, 0x64, 0x00>(), {}, 0,
             SiteDisposition::verify_only}},
        FramerateTargetContract{FramerateNativeTarget::get_config,
            {FeatureId::framerate, "get_config", VersionedOperationKind::read_only_contract, 0x11C0, 8, PatternOf<0x55, 0x8B, 0xEC, 0xE8, 0xE8, 0xFF, 0xFF, 0xFF>(), {}, 0,
             SiteDisposition::verify_only}},
        FramerateTargetContract{FramerateNativeTarget::advance_gameplay_effect,
            {FeatureId::framerate, "advance_gameplay_effect", VersionedOperationKind::read_only_contract, 0x1CD3F0, 9, PatternOf<0x55, 0x8B, 0xEC, 0x83, 0xEC, 0x10, 0x89, 0x4D, 0xF0>(), {}, 0,
             SiteDisposition::verify_only}},
        FramerateTargetContract{FramerateNativeTarget::ranking_resume,
            {FeatureId::framerate, "ranking_resume", VersionedOperationKind::read_only_contract, 0x1EA97F, 10, PatternOf<0xE9, 0x74, 0xFE, 0xFF, 0xFF, 0xE8, 0x27, 0x7E, 0xF6, 0xFF>(), {}, 0,
             SiteDisposition::verify_only}},
        FramerateTargetContract{FramerateNativeTarget::hitchart_resume,
            {FeatureId::framerate, "hitchart_resume", VersionedOperationKind::read_only_contract, 0x22C007, 8, PatternOf<0x8D, 0x4D, 0xA4, 0xE8, 0xD1, 0x43, 0xDF, 0xFF>(), {}, 0,
             SiteDisposition::verify_only}}
};
FramerateGameProfile MakeProfile206(GameImageVariant variant) noexcept {
    return {GameBuild::groove_coaster_206, variant, kWrites206, kHooks206, kTargets206, {
        .tune_current_tick = 0x10,
        .tune_step = 0x14,
        .game_time_offset = 0x2C,
        .gameplay_sound_group = 2,
        .judgement_tune_stack = -0x334,
        .semantic_tune_stack = -0x36C,
        .remote_phase_stack = -0x204,
        .palette_counter = 0x0C,
        .ifbl_wait = 0x3C,
        .tune_countdown = 0x1D14,
        .audio_margin_stack = -0x24,
        ...
        .movieclip_frame_low = 0x178,
        .movieclip_frame_high = 0x17C,
        .player_position_remaining = 0x1D4C,
        .player_position_duration = 0xC4,
        .palette_skip = 4,
        .ifbl_skip = 3,
        .bgm_preload_skip = 3,
        ...
        .effect_advance_skip = 5,
        .player_position_skip = 7,
        .tune_countdown_owner = FramerateRegister::eax,
        .countdown_asset_source = FramerateRegister::edx,
        .tutorial_elapsed_source = FramerateRegister::eax,
        .unlock_reward_prompt_available = false,
    }, EffectTimingManifestSummary{.timing_sites = 32, .hook_contracts = 32,
        .manager_gated = 1, .non_ctune_out_of_scope = 1}};
}
}
...
BindFramerateHook(const FramerateHookContract& contract) noexcept {
    ...
    case FramerateHookId::FixedVisualFrameOperand:
        if (contract.authored_operand_register) {
            switch (*contract.authored_operand_register) {
            case FramerateRegister::eax: return MidHookOperation{contract.site, HookAuthoredOperandEax};
            case FramerateRegister::ecx: return MidHookOperation{contract.site, HookAuthoredOperandEcx};
            case FramerateRegister::edx: return MidHookOperation{contract.site, HookAuthoredOperandEdx};
            }
        }
        break;
...
const FramerateGameProfile* ProfileFor(GameBuild build, GameImageVariant variant) noexcept {
    static const std::array profiles{
        ...
        MakeProfile206(GameImageVariant::clean), MakeProfile206(GameImageVariant::locally_verified)};
