    ...
    namespace
    {
            ...
            const JudgementQueryInvariant invariant) noexcept
        {
            ...
            case JudgementQueryInvariant::ReceiverMismatch:
                return {
                    AbsoluteJudgementFatalPredicate::ScopeReceiverMismatch,
            ...
            case JudgementQueryInvariant::InvalidFrame:
                return {
                    AbsoluteJudgementFatalPredicate::PressedFrameMismatch,
                    AbsoluteJudgementFatalReason::NativeStateMismatch
                };
            case JudgementQueryInvariant::InvalidDirectionArguments:
                return {
                    AbsoluteJudgementFatalPredicate::DirectionOutputNull,
                    AbsoluteJudgementFatalReason::NativeStateMismatch
                };
        ...
        public:
            ...
            CapturePerformanceCounterOrFatal() const noexcept
            {
                LARGE_INTEGER qpc{};
            ...
            {
                return {
                    .qpc_ticks = CapturePerformanceCounterOrFatal(),
            ...
            {
                const bool observe_outer_timing = scheduler_.SemanticStageOpen();
                ...
                if (observe_outer_timing)
                {
                    JudgementDiagnostics().ObserveOuterCallTiming(
                        dispatch_entry_qpc,
                        CapturePerformanceCounterOrFatal());
                }
