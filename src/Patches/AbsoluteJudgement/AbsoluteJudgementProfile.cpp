...
AbsoluteJudgementProfile MakeProfile206(GameImageVariant variant) noexcept {
    const std::array<VersionedOperation, 18> enabled{
        InlineHookOperation{{FeatureId::absolute_judgement, "pressed",
            VersionedOperationKind::inline_hook, 0x1FD6B0, 6, PatternOf<0x55, 0x8B, 0xEC, 0x83, 0xEC, 0x28, 0x89, 0x4D, 0xD8, 0xC6, 0x45, 0xFF, 0x00, 0x8B, 0x4D, 0xD8>(), {}, 0},
            reinterpret_cast<void*>(HookPressed),
            hooking::OriginalPublisher::To(&detail::g_originals.pressed)},
        InlineHookOperation{{FeatureId::absolute_judgement, "held",
            VersionedOperationKind::inline_hook, 0x1FD650, 6, PatternOf<0x55, 0x8B, 0xEC, 0x83, 0xEC, 0x0C, 0x89, 0x4D, 0xF4, 0xC6, 0x45, 0xFF, 0x00, 0x8B, 0x4D, 0xF4>(), {}, 1},
            reinterpret_cast<void*>(HookHeld),
            hooking::OriginalPublisher::To(&detail::g_originals.held)},
        InlineHookOperation{{FeatureId::absolute_judgement, "released",
            VersionedOperationKind::inline_hook, 0x1FD430, 6, PatternOf<0x55, 0x8B, 0xEC, 0x83, 0xEC, 0x28, 0x89, 0x4D, 0xD8, 0xC6, 0x45, 0xFF, 0x00, 0x8B, 0x4D, 0xD8>(), {}, 2},
            reinterpret_cast<void*>(HookReleased),
            hooking::OriginalPublisher::To(&detail::g_originals.released)},
        InlineHookOperation{{FeatureId::absolute_judgement, "direction",
            VersionedOperationKind::inline_hook, 0x1FDB80, 6, PatternOf<0x55, 0x8B, 0xEC, 0x83, 0xEC, 0x08, 0x89, 0x4D, 0xF8, 0x8B, 0x45, 0x0C, 0xD9, 0xEE, 0xD9, 0x18>(), {}, 3},
            reinterpret_cast<void*>(HookDirection),
            hooking::OriginalPublisher::To(&detail::g_originals.direction)},
        InlineHookOperation{{FeatureId::absolute_judgement, "held_age",
            VersionedOperationKind::inline_hook, 0x1FD1A0, 6, PatternOf<0x55, 0x8B, 0xEC, 0x83, 0xEC, 0x08, 0x89, 0x4D, 0xF8, 0xC7, 0x45, 0xFC, 0x00, 0x00, 0x00, 0x00>(), {}, 4},
            reinterpret_cast<void*>(HookHeldAge),
            hooking::OriginalPublisher::To(&detail::g_originals.held_age)},
        MidHookOperation{{FeatureId::absolute_judgement, "loop_guard",
            VersionedOperationKind::mid_hook, 0x20D269, 6, PatternOf<0x0F, 0x8E, 0x17, 0x01, 0x00, 0x00>(), {}, 5}, HookLoopGuard},
        MidHookOperation{{FeatureId::absolute_judgement, "semantic_stage_exit",
            VersionedOperationKind::mid_hook, 0x1C5102, 6, PatternOf<0x8B, 0x95, 0x94, 0xFC, 0xFF, 0xFF, 0xC7, 0x42, 0x04, 0x11, 0x00, 0x00, 0x00>(), {}, 6}, HookSemanticStageExit},
        MidHookOperation{{FeatureId::absolute_judgement, "gameplay_initialization",
            VersionedOperationKind::mid_hook, 0x1C2B89, 8, PatternOf<0x89, 0x4D, 0x90, 0xE8, 0xEF, 0x0C, 0xF9, 0xFF>(), {}, 7}, HookGameplayInitialization},
        MidHookOperation{{FeatureId::absolute_judgement, "semantic_stage_entry",
            VersionedOperationKind::mid_hook, 0x1C451F, 6, PatternOf<0x8B, 0x8D, 0x94, 0xFC, 0xFF, 0xFF, 0xC7, 0x41, 0x10, 0x00, 0x00, 0x00, 0x00>(), {}, 8}, HookSemanticStageEntry},
        InlineHookOperation{{FeatureId::absolute_judgement, "timing_grade",
            VersionedOperationKind::inline_hook, 0x1A9D20, 6, PatternOf<0x55, 0x8B, 0xEC, 0x83, 0xEC, 0x4C, 0x89, 0x4D, 0xCC, 0x8B, 0x45, 0x08, 0xD9, 0x80, 0xB0, 0x00, 0x00, 0x00>(), {}, 9},
            reinterpret_cast<void*>(HookTimingGrade),
            hooking::OriginalPublisher::To(&detail::g_originals.timing_grade)},
        ReadOnlyContractOperation{{FeatureId::absolute_judgement, "loop_tail",
            VersionedOperationKind::read_only_contract, 0x20D386, 15, PatternOf<0x8B, 0x4D, 0xF8, 0x51, 0x8B, 0x8D, 0xCC, 0xFC, 0xFF, 0xFF, 0xE8, 0xDB, 0xE8, 0xE1, 0xFF>(), {}, 0,
            SiteDisposition::verify_only}},
        ReadOnlyContractOperation{{FeatureId::absolute_judgement, "recognition",
            VersionedOperationKind::read_only_contract, 0x1AF5A0, 16, PatternOf<0x55, 0x8B, 0xEC, 0x6A, 0xFF, 0x68, 0xE6, 0x15, 0x64, 0x00, 0x64, 0xA1, 0x00, 0x00, 0x00, 0x00>(), {}, 0,
            SiteDisposition::verify_only}},
        ReadOnlyContractOperation{{FeatureId::absolute_judgement, "score",
            VersionedOperationKind::read_only_contract, 0x1A8870, 12, PatternOf<0x55, 0x8B, 0xEC, 0x83, 0xEC, 0x0C, 0x89, 0x4D, 0xF4, 0x8B, 0x45, 0xF4>(), {}, 0,
            SiteDisposition::verify_only}},
        ReadOnlyContractOperation{{FeatureId::absolute_judgement, "get_input_manager",
            VersionedOperationKind::read_only_contract, 0x1040, 16, PatternOf<0x55, 0x8B, 0xEC, 0x6A, 0xFF, 0x68, 0x2E, 0x3A, 0x64, 0x00, 0x64, 0xA1, 0x00, 0x00, 0x00, 0x00>(), {}, 0,
            SiteDisposition::verify_only}},
        ReadOnlyContractOperation{{FeatureId::absolute_judgement, "get_global",
            VersionedOperationKind::read_only_contract, 0x11B0, 12, PatternOf<0x55, 0x8B, 0xEC, 0xE8, 0x38, 0xFF, 0xFF, 0xFF, 0x5D, 0xC3, 0xCC, 0xCC>(), {}, 0,
            SiteDisposition::verify_only}},
        ReadOnlyContractOperation{{FeatureId::absolute_judgement, "get_config",
            VersionedOperationKind::read_only_contract, 0x11C0, 15, PatternOf<0x55, 0x8B, 0xEC, 0xE8, 0xE8, 0xFF, 0xFF, 0xFF, 0x8B, 0xC8, 0xE8, 0x51, 0x34, 0x02, 0x00>(), {}, 0,
            SiteDisposition::verify_only}},
        ReadOnlyContractOperation{{FeatureId::absolute_judgement, "get_sound_manager",
            VersionedOperationKind::read_only_contract, 0x1E41D0, 12, PatternOf<0x55, 0x8B, 0xEC, 0xA1, 0x10, 0xA9, 0x7A, 0x00, 0x5D, 0xC3, 0xCC, 0xCC>(), {}, 0,
            SiteDisposition::verify_only}},
        ReadOnlyContractOperation{{FeatureId::absolute_judgement, "get_group_cursor",
            VersionedOperationKind::read_only_contract, 0x1E5C60, 16, PatternOf<0x55, 0x8B, 0xEC, 0x6A, 0xFF, 0x68, 0x36, 0x01, 0x64, 0x00, 0x64, 0xA1, 0x00, 0x00, 0x00, 0x00>(), {}, 0,
            SiteDisposition::verify_only}}
    };
    return {GameBuild::groove_coaster_206, variant, enabled,
        {enabled[6], enabled[7], enabled[8], enabled[15]},
        {
            .tune_stack_offset = -0x334,
            .semantic_stage_tune_stack_offset = -0x36C,
            .tune_judgement_states_offset = 0x254,
            .tune_score_states_offset = 0x26C,
            .pointer_collection_begin_offset = 0x0C,
            .pointer_collection_end_offset = 0x10,
            .global_player_index_offset = 0x728,
            .input_manager_booster_offset = 4,
            .game_time_offset_offset = 0x2C,
            .hold_safe_frame_offset = 0x68,
            .slide_hold_safe_frame_offset = 0x6C,
            .score_miss_offset = 120,
            .score_good_offset = 124,
            .score_cool_offset = 128,
            .score_great_offset = 132,
            .judgement_arrange_publication_offset = 0xA8,
            .judgement_left_free_tap_publication_offset = 0xED,
            .judgement_right_free_tap_publication_offset = 0xEE,
            .timing_grade_note_target_float_index = 44,
            .gameplay_sound_group = 2,
